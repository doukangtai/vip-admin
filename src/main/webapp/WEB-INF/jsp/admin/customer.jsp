                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href="${pageContext.request.contextPath}/admin/page/customer">顾客列表</a> </li>
...
<script type="text/javascript">
    $(function(){
        $(document).ready(function(){
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/admin/customer/count",
        ...
        $("tbody").on("click", ".delete-btn", function () {
            ...
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/admin/customer/delete?cid=" + cid,
                success : function(result) {
                    if (result.status == "success") {
                        alert(result.msg)
                        window.location.href = "${pageContext.request.contextPath}/admin/page/customer";
                    }
                },
                error : function(e){
                    console.log(e.status);
