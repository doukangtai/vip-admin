            ...
            <div class="lyear-layout-sidebar-scroll">
                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            <a href="javascript:void(0)"><i class="mdi mdi-language-javascript"></i>会员卡、服务项目管理</a>
                            <ul class="nav nav-subnav">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href="${pageContext.request.contextPath}/admin/page/log">管理订单</a> </li>
                            </ul>
                        </li>
                    </ul>
                </nav>
...
<script type="text/javascript">
    $(function () {
        $(document).ready(function(){
            ...
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/admin/log/count/total",
                success : function(result) {
                    ...
                    $("#xjzPagination").xjzPagination({
                        ...
                        onPageClick: function (currentPage) {
                            ...
                            $.ajax({
                                type : "GET",
                                url : "${pageContext.request.contextPath}/admin/log/page?startIndex=" + (currentPage - 1) * 5 + "&len=" + 5,
                                success : function(result) {
                                    for (let i in result) {
                                        let str = "<tr>\n"+
                                            "<td>"+result[i].lid+"</td>\n"+
        ...
        $("#select-btn").click(function () {
            ...
            if ($("#cphone").val() == '' && $("#ephone").val() == '') {
                urlPage = "${pageContext.request.contextPath}/admin/log/count/total";
                urlData = "${pageContext.request.contextPath}/admin/log/page?"
            } else if ($("#ephone").val() == '') {
                urlPage = "${pageContext.request.contextPath}/admin/log/count/customer?phone=" + $("#cphone").val()
                urlData = "${pageContext.request.contextPath}/admin/log/page/customer?phone=" + $("#cphone").val()
            } else if ($("#cphone").val() == '') {
