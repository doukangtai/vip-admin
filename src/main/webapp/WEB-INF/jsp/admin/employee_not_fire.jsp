...
<script type="text/javascript">
    $(function(){
        $(document).ready(function(){
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/admin/employee/count/notFire",
                success : function(result) {
                    ...
                    $("#xjzPagination").xjzPagination({
                        ...
                        onPageClick: function (currentPage) {
                            ...
                            $.ajax({
                                type : "GET",
                                url : "${pageContext.request.contextPath}/admin/page/employee/page/notFire?startIndex=" + (currentPage - 1) * 5 + "&len=" + 5,
                                success : function(result) {
                                    for (let i in result) {
                                        let temp = ''
