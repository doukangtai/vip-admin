                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href="${pageContext.request.contextPath}/employee/page/customer/update">修改顾客信息</a> </li>
...
<script type="text/javascript">
    $(function(){
        $('#select-customer').click(function () {
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/allVip",
            ...
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/customerVip/" + $("#phone").val(),
                success : function(result) {
                    $("#cid").val(result.cid)
        ...
        $('#customer-charge').click(function () {
            ...
            $.ajax({
                ...
                url : "${pageContext.request.contextPath}/employee/customer/update",
