                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href="${pageContext.request.contextPath}/employee/page/customer/recycle">回收站</a> </li>
                            </ul>
                        </li>
...
<script type="text/javascript">
    $(function(){
        $(document).ready(function(){
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/customer/count/delete",
                success : function(result) {
                    ...
                    $("#xjzPagination").xjzPagination({
                        ...
                        onPageClick: function (currentPage) {
                            ...
                            $.ajax({
                                type : "GET",
                                url : "${pageContext.request.contextPath}/employee/customer/page/delete?startIndex=" + (currentPage - 1) * 5 + "&len=" + 5,
                                success : function(result) {
                                    for (let i in result) {
                                        let temp = ''
        ...
        $("tbody").on("click", ".recycle-btn", function () {
            ...
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/customer/recycle?cid=" + cid,
                success : function(result) {
                    if (result.status == "success") {
                        alert(result.msg)
                        window.location.href = "${pageContext.request.contextPath}/employee/page/customer/recycle";
                    }
                },
                error : function(e){
                    console.log(e.status);
