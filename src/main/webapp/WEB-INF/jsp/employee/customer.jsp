                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href="${pageContext.request.contextPath}/employee/page/customer">顾客列表</a> </li>
...
<script type="text/javascript">
    $(function(){
        $(document).ready(function(){
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/customer/count",
                success : function(result) {
                    ...
                    $("#xjzPagination").xjzPagination({
                        ...
                        onPageClick: function (currentPage) {
                            ...
                            $.ajax({
                                type : "GET",
                                url : "${pageContext.request.contextPath}/employee/customer/page?startIndex=" + (currentPage - 1) * 5 + "&len=" + 5,
                                success : function(result) {
                                    for (let i in result) {
                                        let temp = ''
                                        ...
                                        let str = "<tr>\n"+
                                            ...
                                            "<td>\n" +
                                            "<button cid=\""+result[i].cid+"\" class=\"delete-btn btn btn-danger btn-xs btn-primary\">删除</button>\n" +
                                            "</td>\n"+
                                            "</tr>";
                                        $("tbody").append(str)
                                    }
        ...
        $("tbody").on("click", ".delete-btn", function () {
            ...
            let cid = $(".delete-btn").eq(index).attr("cid");
            $.ajax({
                type : "GET",
                url : "${pageContext.request.contextPath}/employee/customer/delete?cid=" + cid,
                success : function(result) {
                    if (result.status == "success") {
                        alert(result.msg)
                        window.location.href = "${pageContext.request.contextPath}/employee/page/customer";
                    }
                },
                error : function(e){
                    console.log(e.status);
